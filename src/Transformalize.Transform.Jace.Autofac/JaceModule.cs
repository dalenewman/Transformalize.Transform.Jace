...
namespace Transformalize.Transforms.Jace.Autofac {
    public class JaceModule : Module {
        ...
        protected override void Load(ContainerBuilder builder) {
            ...
            var signatures = new JaceTransform().GetSignatures().ToArray();
            ...
            RegisterTransform(builder, c => new JaceTransform(c), signatures);
        }
